...
if __name__ == "__main__":
    train_img_dir = [r"C:\faceRec\dataset\casia-aligned"
                     ]
    test_img_dir = r"C:\faceRec\dataset\lfw"
    label_dict = None
    embed_length = 128
    get_image_type = 'append'
    ...
    model_shape = [None,112,112,3]#at least[None,80,80,3] forinception_resnet_v1
