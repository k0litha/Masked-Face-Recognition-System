...
class Classification():
    ...
    def train(self,para_dict):
        ...
        #GPU settings for nvidia gpu (CUDA)
        ...
        with tf.Session(config=config) as sess:
            ...
            for epoch in range(epochs):
                ...
                for index in range(train_ites):
                    ...
                    # calculating accuracy and the loss
                ...
                #displaying  results of the training
                print("Epoch: ",epoch)
...
if __name__ == "__main__":
    train_img_dir = r"C:\Users\Koli\Desktop\test"
    test_img_dir = r"C:\Users\Koli\Desktop\train"
    label_dict = None
    ...
    opti_method = "adam"
    learning_rate = 1e-4
    save_dir = r"Trained Models\maskmodel"
